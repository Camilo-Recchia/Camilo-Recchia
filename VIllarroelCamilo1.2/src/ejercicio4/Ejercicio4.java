...
public class Ejercicio4 {
	...
	public enum Tamaños{pequeña, mediana, grande,extragrande}
	...
	public static void main(String[] args) {
		...
		System.out.println("Al tener estatura "+sizeGrande+" puedes subirte a la montaña rusa pero sin levantar los brazos");
		System.out.println("Al tener estatura "+sizeExtraGrande+" no puedes subirte a la montaña rusa por tu propio bien");
	}
